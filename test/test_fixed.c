...
static int test_inc1s(void)
{
	...
	/* data */
	test_file_open(&s, &file, "file/inc.txt");
	for (;;) {
...
static int test_shiftl1(void)
{
	...
	/* data */
	test_file_open(&s, &file, "file/shiftl.txt");
	for (;;) {
		x = test_file_push(s, file);
		if (x < 0)
			break;
...
static int test_shiftr1(void)
{
	...
	/* data */
	test_file_open(&s, &file, "file/shiftr.txt");
	for (;;) {
		x = test_file_push(s, file);
		if (x < 0)
			break;
...
static int test_div(void)
{
	...
	/* data */
	test_file_open(&s, &file, "file/div.txt");
	for (;;) {
		x = test_file_push(s, file);
		if (x < 0)
			break;
...
static int test_power_mod(void)
{
	...
	/* data */
	test_file_open(&s, &file, "file/power_mod.txt");
	for (;;) {
		x = test_file_push(s, file);
		if (x < 0)
			break;
...
static int test_rotatel(void)
{
	...
	test_file_open(&s, &file, "file/rotatel.txt");
	for (;;) {
		x = test_file_push(s, file);
		if (x < 0)
			break;
...
static int test_rotater(void)
{
	...
	test_file_open(&s, &file, "file/rotater.txt");
	for (;;) {
		x = test_file_push(s, file);
		if (x < 0)
			break;
